	...
	<div class="innerContainer">
		<div class="midContainer">
			<div class="midTopbg"></div>
						...
						<div class="leftBGnav"></div>
							<div class="leftBg">
								...
								<div class="leftAdd"><table width="99%" height="232" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <th height="137" colspan="2" ><div align="center"><img src="images/The_Lost_City_Of_Z-David_Grann.jpg" alt="The Lost City Of Z" width="80" height="104" /></div></th>
                                    </tr>
				...
				<div class="midCright"><div class="banner"><img src="images/InnerBanner.jpg" width="751" height="123" /></div>
				...
				<div class="lcontainerTop"><img src="images/logintop.gif" /></div>
					<div class="lcontainerCon">
						...
						<li style="background-image:none;"><img src="images/Jordan-Driven_From_Within.jpg" /></li>
						...
						<s:form id="itemsForm" name="itemsForm" action="ViewCart!addToCart.action" theme="simple">
						...
						<c:forEach var="item" items="${itemsList}" varStatus="status" step="1" begin="0">
										 ...
										 <td>
    										<div class="itemBoxes">
    											...
    											<div class="itemDes" id="<c:out value='${item.id}'/>_title"><c:out value="${item.title}"/></div>
												<div class="Cart">Add to Cart
										        <input type="checkbox" id="selectedId" name="selectedId" value="<c:out value="${item.id}"/>" onclick='setValue(this);' />
      											</div>
    										</div>
    									</td>
				...
				<s:hidden id="selectedItemId" name="selectedItemId"></s:hidden>
						    ...
						    <table>
						    	<tr>
						    	<td>
									<div class="buttonClass"><s:submit cssClass="submit" name="submitValue" key="label.addtocart"/></div>
								</td>
								 <td>
									<div class="buttonClass"><s:submit cssClass="submit" name="submitValue" key="lable.postxml" onclick="submitXML();"/></div>
								</td>
								</tr>
							</table>		
							</s:form>
