				...
				<div class="lcontainerCon">
					...
					<div class="Selecttext">
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <th width="20%"  ><div class="Selecttext"> Item Id</div></th>
                          <th width="58%"><div class="Selecttext">Item Title</div></th>
                          <th width="22%"><div class="Selecttext">Select</div></th>
                        </tr>
                      </table>
					</div>
					...
					<div class="selcetedItemBg">
					  <div class="Selectc">
					  <div class="Selecttext">
					   <s:form  name="itemsForm"  action="ViewCart!sendItems.action" theme="simple">
					        ...
					        <c:set var="items" value="${cartList.items}"/>
                      		<c:forEach var="item" items="${items}">
								<tr>
									...
									<td width="22%"><c:out value="${item.price}"/></td>
								</tr>
							</c:forEach>
							
					   </table>
					   <br/><br/>
					  <s:checkbox name="checkMe"   label="Get the Invoice ID"/><font color="#3F3C3C"><b>Get Invoice ID</b></font>
					  <br/>
					   <div>
							<s:submit name="submitValue" cssClass="submit" key="label.buynow"/>
					   </div>
					   </s:form>
					  </div>
