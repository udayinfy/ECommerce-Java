					...
					<div class="tb" ><div class="tlc" ><div class="trc" >
						<div class="categoriesContent">
							...
							<table class="others2" border="0" align="left">
								...
								<tr>
									<td width="167"><c:out value="${item.id}"/></td>
									<td width="167" id="<c:out value='${item.id}'/>_title"><c:out value="${item.title}"/></td>
									<td width="167"><img src='<c:out value="${item.imagePath}"/>'/></td>
									<td width="166">
