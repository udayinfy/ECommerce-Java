...
while(sleep_now+5000>Number(new Date())) { var tmp = sleep_now; }
...
<div style="background: #333; color: white; padding: 8px;">
  ...
  <font style="font-size: 2em; font-weight: bold; margin-right: 10px;"><a href="http://stevesouders.com/cuzillion/" style="color:white; text-decoration: none;"><img border="0" src="./slow3_files/logo-32x32.gif">&nbsp;Cuzillion</a></font><i>'cuz there are a zillion pages to check</i>
</div>
...
function create_elem2() {
  ...
  xhrObj_elem2.onreadystatechange = function() { if ( xhrObj_elem2.readyState != 4 || 200 != xhrObj_elem2.status ) return; var se = document.createElement('script'); document.getElementsByTagName('head')[0].appendChild(se); se.text = xhrObj_elem2.responseText; };
  try {
...
<div id="pageavatar" style="float: left; width: 310px; margin-right: 30px;">
  ...
  <div id="loadedscripts" style="text-align: left; margin-top: 10px; width: 300px; font-size: 0.9em;"><nobr>7133ms: "http://stevesouders.com/bin/resource.cgi?type=js&amp;sleep=0&amp;jsdelay=5&amp;n=2&amp;t=1376427457" done</nobr>
</div>
</div> <!-- end pageavatar -->
...
<input type="button" value="Reload" onclick="reloadPage(&#39;/cuzillion/?c0=bi1hfff2_0_f&amp;c1=bj1iftf0_5_f&amp;t=1376427457&#39;)">&nbsp;&nbsp;
